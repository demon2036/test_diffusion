...
def create_input_pipeline_torch(num_workers=jax.device_count()*2,batch_size=64,*args, **kwargs):
    ...
    dataloader = DataLoader(dataset, num_workers=num_workers, prefetch_factor=2, batch_size=batch_size, drop_last=True,
