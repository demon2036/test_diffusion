...
from diffusers import FlaxModelMixin
...
class FlaxUNet2DConditionModel(nn.Module, FlaxModelMixin, ConfigMixin):
    ...
    up_block_types: Tuple[str, ...] = ("UpBlock2D", "UpBlock2D", "UpBlock2D",
                                       "UpBlock2D")  # ("UpBlock2D", "CrossAttnUpBlock2D", "CrossAttnUpBlock2D", "CrossAttnUpBlock2D")
    only_cross_attention: Union[bool, Tuple[bool]] = False
    block_out_channels: Tuple[int, ...] = (128, 256, 512, 512)  # (320, 640, 1280, 1280)
    ...
    def setup(self) -> None:
        ...
        self.mid_block = FlaxDownBlock2D(
    ...
    def __call__(
        ...
        print(sample.shape)
        sample, res_samples = self.mid_block(sample, t_emb, deterministic=not train)
